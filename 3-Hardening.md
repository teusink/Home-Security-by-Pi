...
- Now it is time to remove some unneeded software and games from Pi.
   ...
   - Remove Redundant stuff: `sudo apt-get remove --purge bluej claws-mail claws-mail-i18n geany greenfoot libreoffice* minecraft-pi nodered nuscratch python-pygame scratch scratch2 sonic-pi wolfram-engine`
