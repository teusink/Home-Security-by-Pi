...
- Add this line: `0 1 * * * sudo sh ./pi-security-scan.sh >/home/pi/pi-security-scan.log 2>&1`. This line means that it will do an update of the definition files and scan the entire Pi every night at 1 am and it outputs it logs to a log file.
